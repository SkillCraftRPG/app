...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      path: "/customizations/import",
      component: () => import("./views/customizations/CustomizationImport.vue"),
    },
    // Educations
    {
      name: "Educations",
    ...
    {
      name: "EducationImport",
      path: "/educations/import",
      component: () => import("./views/educations/EducationImport.vue"),
    },
    {
      name: "Education",
      path: "/educations/:id",
    ...
    },
    {
      name: "ScriptImport",
      path: "/scripts/import",
      component: () => import("./views/scripts/ScriptImport.vue"),
    },
    {
      name: "Script",
      path: "/scripts/:id",
