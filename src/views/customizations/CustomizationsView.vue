    ...
    <div v-if="hasLoaded" class="d-flex flex-column flex-grow-1">
      <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start gap-3">
        ...
        <div class="d-flex gap-2">
          ...
          <RouterLink class="btn btn-outline-primary btn-lg mb-3" :to="{ name: 'CustomizationImport' }">
...
import CustomizationLinkCard from "@/components/customizations/CustomizationLinkCard.vue";
