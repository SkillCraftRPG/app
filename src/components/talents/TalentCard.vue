<template>
  <LinkCard :to="{ name: 'Talent', params: { id: talent.id } }">
    ...
    <div v-if="talent.skill || talent.allowMultiplePurchases" class="card-text d-flex justify-content-between align-items-center gap-2 mb-2">
      ...
      <div v-if="talent.allowMultiplePurchases" class="text-end">
