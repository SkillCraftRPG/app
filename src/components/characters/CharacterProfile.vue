...
import AgeField from "./profile/AgeField.vue";
import BackgroundField from "./profile/BackgroundField.vue";
import CharacterAlignment from "./profile/CharacterAlignment.vue";
import DominantHandRadio from "./profile/DominantHandRadio.vue";
import EyesField from "./profile/EyesField.vue";
import FlawsField from "./profile/FlawsField.vue";
import HairField from "./profile/HairField.vue";
import HeightField from "./profile/HeightField.vue";
import IdealsField from "./profile/IdealsField.vue";
import NameField from "@/components/shared/NameField.vue";
import PersonalityField from "./profile/PersonalityField.vue";
import SkinField from "./profile/SkinField.vue";
import TarButton from "@/components/tar/TarButton.vue";
import WeightField from "./profile/WeightField.vue";
