...
public class PermissionDeniedException : ForbiddenException
{
  ...
  public PermissionDeniedException(Action action, EntityType entityType, User user, World? world = null, Guid? entityId = null)
  ...
  private static string BuildMessage(Action action, EntityType entityType, User user, World? world, Guid? entityId) => new ErrorMessageBuilder(ErrorMessage)
