...
internal class StorageEvents : INotificationHandler<Storage.EntityStoredEvent>, INotificationHandler<Storage.InitializedEvent>
{
  private readonly SkillCraftContext _context;

  public StorageEvents(SkillCraftContext context)
  {
    _context = context;
  }
