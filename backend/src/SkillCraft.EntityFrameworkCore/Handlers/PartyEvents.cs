...
internal class PartyEvents : INotificationHandler<Party.CreatedEvent>, INotificationHandler<Party.UpdatedEvent>
{
  private readonly SkillCraftContext _context;

  public PartyEvents(SkillCraftContext context)
  {
    _context = context;
  }
