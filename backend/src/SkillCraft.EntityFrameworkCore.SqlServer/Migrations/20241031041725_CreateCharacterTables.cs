        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BestAttribute = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    WorstAttribute = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    MandatoryAttributes = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    OptionalAttributes = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ExtraAttributes = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CharacterTalentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CharacterId = table.Column<int>(type: "int", nullable: false),
                    TalentId = table.Column<int>(type: "int", nullable: false),
                    Cost = table.Column<int>(type: "int", nullable: false),
                    Precision = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContainingItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    IsAttuned = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    RemainingCharges = table.Column<int>(type: "int", nullable: true),
                    RemainingResistance = table.Column<int>(type: "int", nullable: true),
                    NameOverride = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    DescriptionOverride = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ValueOverride = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
