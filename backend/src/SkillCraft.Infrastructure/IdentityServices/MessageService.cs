...
internal class MessageService : IMessageService
{
  ...
  public async Task<SentMessages> SendAsync(string template, Email email, string? locale, IEnumerable<KeyValuePair<string, string>>? variables, CancellationToken cancellationToken)
  {
  ...
  public async Task<SentMessages> SendAsync(string template, User user, string? locale, IEnumerable<KeyValuePair<string, string>>? variables, CancellationToken cancellationToken)
  {
    RecipientPayload recipient = new()
    {
      Type = RecipientType.To,
