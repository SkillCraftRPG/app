...
internal abstract class SearchResultsGraphType<TGraphType, TSourceType> : ObjectGraphType<SearchResults<TSourceType>> where TGraphType : ObjectGraphType<TSourceType>
{
